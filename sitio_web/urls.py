...
from dashboard.views import login_view, authorize_view, logout_view, ver_dashboard, dashboard_usuario, validar_asistencia, redireccion_por_grupo, ver_tabla_dynamo, ver_usuarios_activos, desvincular_rfid
...
urlpatterns = [
    ...
    path("usuario/desvincular-rfid/", desvincular_rfid, name="desvincular_rfid"),  # 🔁 Esta línea debe existir
